...
from dogechia.protocols.full_node_protocol import (
    RejectBlocks,
    RequestBlocks,
    RespondBlock,
    RespondBlocks,
...
class FullNode:
    ...
    def set_server(self, server: DogeChiaServer):
        ...
        if "dns_servers" in self.config:
            ...
            dns_servers.append("dns-introducer.dogechia.org")
        try:
    ...
    async def short_sync_batch(self, peer: ws.WSDogeChiaConnection, start_height: uint32, target_height: uint32) -> bool:
        """
    ...
    async def short_sync_backtrack(
        self, peer: ws.WSDogeChiaConnection, peak_height: uint32, target_height: uint32, target_unf_hash: bytes32
    ):
        """
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSDogeChiaConnection):
        """
    ...
    async def send_peak_to_timelords(
        self, peak_block: Optional[FullBlock] = None, peer: Optional[ws.WSDogeChiaConnection] = None
    ):
        """
    ...
    async def on_connect(self, connection: ws.WSDogeChiaConnection):
        """
    ...
    async def peak_post_processing(
        self, block: FullBlock, record: BlockRecord, fork_height: uint32, peer: Optional[ws.WSDogeChiaConnection]
    ):
        """
    ...
    async def respond_block(
        ...
        peer: Optional[ws.WSDogeChiaConnection] = None,
    ) -> Optional[Message]:
        """
    ...
    async def respond_unfinished_block(
        ...
        peer: Optional[ws.WSDogeChiaConnection],
    ...
    async def new_infusion_point_vdf(
        self, request: timelord_protocol.NewInfusionPointVDF, timelord_peer: Optional[ws.WSDogeChiaConnection] = None
    ) -> Optional[Message]:
