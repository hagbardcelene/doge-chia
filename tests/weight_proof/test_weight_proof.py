...
from dogechia.server.start_full_node import SERVICE_NAME
...
from dogechia.consensus.pot_iterations import calculate_iterations_quality
from dogechia.full_node.weight_proof import (  # type: ignore
    WeightProofHandler,
