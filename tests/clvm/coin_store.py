...
from dogechia.full_node.mempool_check_conditions import mempool_check_conditions_dict  # noqa
...
class CoinStore:
    ...
    def farm_coin(
        ...
        amount: int = 1024,
        prefix=bytes32.fromhex("95e3f4db3a329e250187266b27e54fbe00000000000000000000000000000000"),  # noqa
    ) -> Coin:
        parent = bytes32(
            [
                a | b
