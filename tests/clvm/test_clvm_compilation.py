...
wallet_program_files = set(
    [
        "dogechia/wallet/puzzles/calculate_synthetic_public_key.clvm",
        "dogechia/wallet/puzzles/cc.clvm",
        "dogechia/wallet/puzzles/dogechialisp_deserialisation.clvm",
        "dogechia/wallet/puzzles/rom_bootstrap_generator.clvm",
        "dogechia/wallet/puzzles/generator_for_single_coin.clvm",
        "dogechia/wallet/puzzles/genesis-by-coin-id-with-0.clvm",
        "dogechia/wallet/puzzles/genesis-by-puzzle-hash-with-0.clvm",
        "dogechia/wallet/puzzles/lock.inner.puzzle.clvm",
        "dogechia/wallet/puzzles/p2_conditions.clvm",
        "dogechia/wallet/puzzles/p2_delegated_conditions.clvm",
        "dogechia/wallet/puzzles/p2_delegated_puzzle.clvm",
        "dogechia/wallet/puzzles/p2_delegated_puzzle_or_hidden_puzzle.clvm",
        "dogechia/wallet/puzzles/p2_m_of_n_delegate_direct.clvm",
        "dogechia/wallet/puzzles/p2_puzzle_hash.clvm",
        "dogechia/wallet/puzzles/rl_aggregation.clvm",
        "dogechia/wallet/puzzles/rl.clvm",
        "dogechia/wallet/puzzles/sha256tree_module.clvm",
        "dogechia/wallet/puzzles/singleton_top_layer.clvm",
        "dogechia/wallet/puzzles/did_innerpuz.clvm",
        "dogechia/wallet/puzzles/decompress_puzzle.clvm",
        "dogechia/wallet/puzzles/decompress_coin_solution_entry_with_prefix.clvm",
        "dogechia/wallet/puzzles/decompress_coin_solution_entry.clvm",
        "dogechia/wallet/puzzles/block_program_zero.clvm",
        "dogechia/wallet/puzzles/test_generator_deserialize.clvm",
        "dogechia/wallet/puzzles/test_multiple_generator_input_arguments.clvm",
        "dogechia/wallet/puzzles/p2_singleton.clvm",
        "dogechia/wallet/puzzles/pool_waitingroom_innerpuz.clvm",
        "dogechia/wallet/puzzles/pool_member_innerpuz.clvm",
        "dogechia/wallet/puzzles/singleton_launcher.clvm",
        "dogechia/wallet/puzzles/p2_singleton_or_delayed_puzhash.clvm",
    ]
)

clvm_include_files = set(
    ["dogechia/wallet/puzzles/create-lock-puzzlehash.clvm", "dogechia/wallet/puzzles/condition_codes.clvm"]
)

CLVM_PROGRAM_ROOT = "dogechia/wallet/puzzles"
...
class TestClvmCompilation(TestCase):
    ...
    def test_all_programs_listed(self):
        """
        Checks to see if a new .clvm file was added to dogechia/wallet/puzzles, but not added to `wallet_program_files`
        """
