...
from dogechia.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from dogechia.protocols import farmer_protocol
...
from dogechia.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "xdg"), encode_puzzle_hash(new_ph_2, "xdg"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "xdg"))
            ...
            assert config["farmer"]["xdg_target_address"] == encode_puzzle_hash(new_ph, "xdg")
            assert config["pool"]["xdg_target_address"] == encode_puzzle_hash(new_ph_3, "xdg")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "xdg")
