...
from dogechia.pools.pool_config import PoolWalletConfig
from dogechia.util.config import load_config, save_config, create_default_chia_config
...
def test_pool_config():
    ...
    create_default_dogechia_config(test_root, ["config.yaml"])
