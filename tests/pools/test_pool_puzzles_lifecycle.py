...
from dogechia.wallet.puzzles.p2_conditions import puzzle_for_conditions
from dogechia.wallet.puzzles import singleton_top_layer
from dogechia.pools.pool_wallet_info import PoolState
...
This test suite aims to test:
    - dogechia.pools.pool_puzzles.py
    - dogechia.wallet.puzzles.pool_member_innerpuz.clvm
    - dogechia.wallet.puzzles.pool_waiting_room_innerpuz.clvm
"""
...
class TestPoolPuzzles(TestCase):
    def test_pool_lifecycle(self):
        ...
        GENESIS_CHALLENGE = bytes32.fromhex("95e3f4db3a329e250187266b27e54fbec399957cbcdcdc84953180f522436c02")
